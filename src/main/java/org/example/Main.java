...
public class Main {
    public static void main(String[] args) {
        ...
        Note firstExamNotePROG1 = new Note(16, List.of(history1,history2),PROG1);
        Note firstTestNoteProg1 = new Note(14, List.of(),PROG1);
        Note firstExamNoteWeb1 = new Note(17,List.of(),WEB1);
        Note finalExamNoteProg1 = new Note(13,List.of(),PROG1);
