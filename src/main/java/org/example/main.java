...
Student        student1 = new Student(1, "Bryar","Emily"
      ...
      Note  note1 = new Note(13.50,student1);
      Note  note2 =  new Note(16.00,student1);
      Note  note3 =  new Note(14.50,student1);
      Note  note4 =  new Note(17.00,student2);
      Note  note5 =  new Note(12.25,student2);
     ...
     History history1 =  new History(13.00, Instant.now()
      ...
      History  history3 = new History(14.00, Instant.now(),"réussite à un test");
      History  history4 = new History(11.00, Instant.now(),"punition collectif due au bavardage");
